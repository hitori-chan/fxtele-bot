...
class PixivTokenFetcher:
    ...
    def fetch_code(self):
        with sync_playwright() as p:
            browser = p.chromium.launch(executable_path="/usr/bin/google-chrome-stable", headless=self.headless, args=[
                "--no-sandbox",
...
if __name__ == "__main__":
    ...
    fetcher = PixivTokenFetcher(username=username, password=password, headless=False)
